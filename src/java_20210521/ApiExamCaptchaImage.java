...
public class ApiExamCaptchaImage {
    ...
    public static void main(String[] args) {
        String clientId = "7lRABRBtL6RSRk0ODBqW"; //애플리케이션 클라이언트 아이디값";
        String clientSecret = "D7oFtjoAod"; //애플리케이션 클라이언트 시크릿값";

        String key = "HL93f7esEm9Xtcjv"; // https://openapi.naver.com/v1/captcha/nkey 호출로 받은 키값
